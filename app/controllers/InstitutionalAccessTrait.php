...
trait InstitutionalAccessTrait
{
    ...
    private function buildGenericSubserviceRoute(string $subserviceKey): string
    {
        ...
        $knownRoute = match ($normalizedKey) {
            ...
            'gerenciamento_de_cardapio' => '/institucional/gerenciamento-cardapio',
            'gerenciamento_cardapio' => '/institucional/gerenciamento-cardapio',
            'cardapio_gerenciamento' => '/institucional/gerenciamento-cardapio',
            'gerenciar_cardapio' => '/institucional/gerenciamento-cardapio',
            'cardapio' => '/institucional/cardapio',
    ...
    private function buildTesterInstitutionalCatalog(): array
    {
        return [
            ...
            [
                ...
                'key' => 'operacoes',
                'subservices' => [
                    $this->buildTesterCatalogSubservice('gerenciamento_de_cardapio', 'Gerenciamento de Cardápio'),
                    $this->buildTesterCatalogSubservice('cardapio', 'Cardápio'),
